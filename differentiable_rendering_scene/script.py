...
from acc_3dto2d_proj import acc_3dto2d_proj
...
# 路径
base_path = "D:\\repos\\Sonar-simulator-blender\\differentiable_rendering_scene\\"
...
def imageGeneration(num):
    ...
    polar, counter = acc_3dto2d_proj(pos_c, intensity_img, nbins, nbeams, vertical_fov, far_bound, near_bound, distance_resolution)
